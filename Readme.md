...
it is very well documented. In the LISP-CV-MASTER/EXAMPLES/EXAMPLES.LISP file there 
...
used in the most basic way. See LISP-CV-MASTER/EXAMPLES/EXAMPLES.LISP for an example 
