...
(asdf:defsystem #:lisp-cv
  ...
  :components ((:file "package") 
	           ...
	           (:file "imgproc" :depends-on ("package" "lisp-cv" "constants" "core"))
	           (:file "highgui" :depends-on ("package" "lisp-cv" "constants" "core"))
               (:file "features2d" :depends-on ("package" "lisp-cv" "constants" "core"))
               (:file "macros" :depends-on ("package" "lisp-cv" "constants" "core" "highgui" "imgproc" "features2d"))))
