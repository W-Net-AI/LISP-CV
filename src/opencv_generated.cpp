...
SIFT* cv_create_SIFT(int nfeatures, int nOctaveLayers, double contrastThreshold, double edgeThreshold, double sigma) {
...
void cv_KDTree_build3(KDTree* self, Mat* points, Mat* labels, bool copyAndReorderPoints) {
	self->build(*points, *labels, copyAndReorderPoints);
}
void cv_Index_build3_0(Index* self, Mat* features, IndexParams* params, cvflann_flann_distance_t* distType) {
...
Point* cv_AlignMTB_calculateShift(AlignMTB* self, Mat* img0, Mat* img1) {
	return new Point(self->calculateShift(*img0, *img1));
}
...
void cv_CvSVM_clear0(CvSVM* self) {
	self->clear();
}
void cv_EM_clear0_0(EM* self) {
	self->clear();
}
void cv_CvDTree_clear0_1(CvDTree* self) {
	self->clear();
}
void cv_CvRTrees_clear0_2(CvRTrees* self) {
	self->clear();
}
void cv_CvBoost_clear0_3(CvBoost* self) {
	self->clear();
}
void cv_CvGBTrees_clear0_4(CvGBTrees* self) {
	self->clear();
}
...
void cv_StereoMatcher_compute3_0(StereoMatcher* self, Mat* left, Mat* right, Mat* disparity) {
...
void cv_AlignMTB_computeBitmaps(AlignMTB* self, Mat* img, Mat* tb, Mat* eb) {
	self->computeBitmaps(*img, *tb, *eb);
}
...
DescriptorExtractor* cv_DescriptorExtractor_create1_0(DescriptorExtractor* self, String* descriptorExtractorType) {
	return &*self->create(*descriptorExtractorType);
}
...
CalibrateDebevec* cv_createCalibrateDebevec(int samples, float lambda, bool random) {
	return &*cv::createCalibrateDebevec(samples, lambda, random);
}
CalibrateRobertson* cv_createCalibrateRobertson(int max_iter, float threshold) {
...
MergeDebevec* cv_createMergeDebevec() {
	return &*cv::createMergeDebevec();
}
MergeMertens* cv_createMergeMertens(float contrast_weight, float saturation_weight, float exposure_weight) {
...
Tonemap* cv_createTonemap(float gamma) {
	return &*cv::createTonemap(gamma);
}
TonemapDrago* cv_createTonemapDrago(float gamma, float saturation, float bias) {
	return &*cv::createTonemapDrago(gamma, saturation, bias);
}
TonemapDurand* cv_createTonemapDurand(float gamma, float contrast, float saturation, float sigma_space, float sigma_color) {
	return &*cv::createTonemapDurand(gamma, contrast, saturation, sigma_space, sigma_color);
}
TonemapMantiuk* cv_createTonemapMantiuk(float gamma, float scale, float saturation) {
	return &*cv::createTonemapMantiuk(gamma, scale, saturation);
}
TonemapReinhard* cv_createTonemapReinhard(float gamma, float intensity, float light_adapt, float color_adapt) {
...
int cv_SIFT_descriptorSize(SIFT* self) {
	return self->descriptorSize();
}
int cv_SURF_descriptorSize0(SURF* self) {
	return self->descriptorSize();
}
int cv_SIFT_descriptorType(SIFT* self) {
	return self->descriptorType();
}
...
bool cv_FeatureDetector_empty0(FeatureDetector* self) {
	return self->empty();
}
bool cv_DescriptorExtractor_empty0_0(DescriptorExtractor* self) {
	return self->empty();
}
bool cv_DescriptorMatcher_empty0_1(DescriptorMatcher* self) {
	return self->empty();
}
bool cv_CascadeClassifier_empty0_2(CascadeClassifier* self) {
	return self->empty();
}
...
void cv_fastNlMeansDenoising(Mat* src, Mat* dst, float h, int templateWindowSize, int searchWindowSize) {
	cv::fastNlMeansDenoising(*src, *dst, h, templateWindowSize, searchWindowSize);
}
void cv_fastNlMeansDenoisingColored(Mat* src, Mat* dst, float h, float hColor, int templateWindowSize, int searchWindowSize) {
	cv::fastNlMeansDenoisingColored(*src, *dst, h, hColor, templateWindowSize, searchWindowSize);
}
void cv_fastNlMeansDenoisingColoredMulti(vector_Mat* srcImgs, Mat* dst, int imgToDenoiseIndex, int temporalWindowSize, float h, float hColor, int templateWindowSize, int searchWindowSize) {
...
void cv_fastNlMeansDenoisingMulti(vector_Mat* srcImgs, Mat* dst, int imgToDenoiseIndex, int temporalWindowSize, float h, int templateWindowSize, int searchWindowSize) {
...
bool cv_VideoCapture_open1(VideoCapture* self, String* filename) {
	return self->open(*filename);
}
bool cv_VideoCapture_open1_0(VideoCapture* self, int device) {
...
void cv_StarDetector_call2(StarDetector* self, Mat* image, vector_KeyPoint* keypoints) {
	self->operator ()(*image, *keypoints);
}
void cv_MSER_call3(MSER* self, Mat* image, vector_vector_Point* msers, Mat* mask) {
	self->operator ()(*image, *msers, *mask);
}
void cv_StereoVar_call3_0(StereoVar* self, Mat* left, Mat* right, Mat* disp) {
...
FileNode* cv_FileNode_getelem1(FileNode* self, c_string nodename) {
	return new FileNode(self->operator[](nodename));
}
FileNode* cv_FileNode_getelem1_0(FileNode* self, int i) {
	return new FileNode(self->operator[](i));
}
float cv_KeyPoint_overlap(KeyPoint* self, KeyPoint* kp1, KeyPoint* kp2) {
	return self->overlap(*kp1, *kp2);
}
...
void cv_Tonemap_process(Tonemap* self, Mat* src, Mat* dst) {
	self->process(*src, *dst);
}
void cv_AlignMTB_process2(AlignMTB* self, vector_Mat* src, vector_Mat* dst) {
	self->process(*src, *dst);
}
void cv_MergeMertens_process2_0(MergeMertens* self, vector_Mat* src, Mat* dst) {
	self->process(*src, *dst);
}
void cv_CalibrateCRF_process3(CalibrateCRF* self, vector_Mat* src, Mat* dst, Mat* times) {
	self->process(*src, *dst, *times);
}
void cv_MergeDebevec_process3_0(MergeDebevec* self, vector_Mat* src, Mat* dst, Mat* times) {
	self->process(*src, *dst, *times);
}
void cv_MergeRobertson_process3_1(MergeRobertson* self, vector_Mat* src, Mat* dst, Mat* times) {
	self->process(*src, *dst, *times);
}
void cv_AlignExposures_process4(AlignExposures* self, vector_Mat* src, vector_Mat* dst, Mat* times, Mat* response) {
	self->process(*src, *dst, *times, *response);
}
void cv_AlignMTB_process4_0(AlignMTB* self, vector_Mat* src, vector_Mat* dst, Mat* times, Mat* response) {
	self->process(*src, *dst, *times, *response);
}
void cv_MergeExposures_process4_1(MergeExposures* self, vector_Mat* src, Mat* dst, Mat* times, Mat* response) {
	self->process(*src, *dst, *times, *response);
}
void cv_MergeDebevec_process4_2(MergeDebevec* self, vector_Mat* src, Mat* dst, Mat* times, Mat* response) {
	self->process(*src, *dst, *times, *response);
}
void cv_MergeMertens_process4_3(MergeMertens* self, vector_Mat* src, Mat* dst, Mat* times, Mat* response) {
	self->process(*src, *dst, *times, *response);
}
void cv_MergeRobertson_process4_4(MergeRobertson* self, vector_Mat* src, Mat* dst, Mat* times, Mat* response) {
	self->process(*src, *dst, *times, *response);
}
...
void cv_Index_release0(Index* self) {
	self->release();
}
void cv_VideoCapture_release0_0(VideoCapture* self) {
	self->release();
}
void cv_VideoWriter_release0_1(VideoWriter* self) {
	self->release();
}
...
void cv_TonemapDrago_setBias(TonemapDrago* self, float bias) {
	self->setBias(bias);
}
...
void cv_TonemapReinhard_setColorAdaptation(TonemapReinhard* self, float color_adapt) {
	self->setColorAdaptation(color_adapt);
}
...
void cv_TonemapDurand_setContrast(TonemapDurand* self, float contrast) {
	self->setContrast(contrast);
}
void cv_MergeMertens_setContrastWeight(MergeMertens* self, float contrast_weiht) {
	self->setContrastWeight(contrast_weiht);
}
void cv_AlignMTB_setCut(AlignMTB* self, bool value) {
	self->setCut(value);
}
...
void cv_CalibrateDebevec_setLambda(CalibrateDebevec* self, float lambda) {
	self->setLambda(lambda);
}
void cv_TonemapReinhard_setLightAdaptation(TonemapReinhard* self, float light_adapt) {
	self->setLightAdaptation(light_adapt);
}
...
void cv_AlignMTB_setMaxBits(AlignMTB* self, int max_bits) {
	self->setMaxBits(max_bits);
}
...
void cv_CalibrateRobertson_setMaxIter(CalibrateRobertson* self, int max_iter) {
...
void cv_CalibrateDebevec_setRandom(CalibrateDebevec* self, bool random) {
...
void cv_CalibrateDebevec_setSamples(CalibrateDebevec* self, int samples) {
	self->setSamples(samples);
}
void cv_TonemapDrago_setSaturation(TonemapDrago* self, float saturation) {
	self->setSaturation(saturation);
}
void cv_TonemapDurand_setSaturation1(TonemapDurand* self, float saturation) {
	self->setSaturation(saturation);
}
void cv_TonemapMantiuk_setSaturation1_0(TonemapMantiuk* self, float saturation) {
	self->setSaturation(saturation);
}
void cv_MergeMertens_setSaturationWeight(MergeMertens* self, float saturation_weight) {
	self->setSaturationWeight(saturation_weight);
}
...
void cv_CalibrateRobertson_setThreshold(CalibrateRobertson* self, float threshold) {
...
bool cv_CvKNearest_train6(CvKNearest* self, Mat* trainData, Mat* responses, Mat* sampleIdx, bool isRegression, int maxK, bool updateBase) {
	return self->train(*trainData, *responses, *sampleIdx, isRegression, maxK, updateBase);
}
int cv_CvANN_MLP_train6_0(CvANN_MLP* self, Mat* inputs, Mat* outputs, Mat* sampleWeights, Mat* sampleIdx, CvANN_MLP_TrainParams* params, int flags) {
	return self->train(*inputs, *outputs, *sampleWeights, *sampleIdx, *params, flags);
}
bool cv_CvDTree_train8(CvDTree* self, Mat* trainData, int tflag, Mat* responses, Mat* varIdx, Mat* sampleIdx, Mat* varType, Mat* missingDataMask, CvDTreeParams* params) {
	return self->train(*trainData, tflag, *responses, *varIdx, *sampleIdx, *varType, *missingDataMask, *params);
}
bool cv_CvRTrees_train8_0(CvRTrees* self, Mat* trainData, int tflag, Mat* responses, Mat* varIdx, Mat* sampleIdx, Mat* varType, Mat* missingDataMask, CvRTParams* params) {
	return self->train(*trainData, tflag, *responses, *varIdx, *sampleIdx, *varType, *missingDataMask, *params);
}
bool cv_CvERTrees_train8_1(CvERTrees* self, Mat* trainData, int tflag, Mat* responses, Mat* varIdx, Mat* sampleIdx, Mat* varType, Mat* missingDataMask, CvRTParams* params) {
	return self->train(*trainData, tflag, *responses, *varIdx, *sampleIdx, *varType, *missingDataMask, *params);
}
bool cv_CvBoost_train9(CvBoost* self, Mat* trainData, int tflag, Mat* responses, Mat* varIdx, Mat* sampleIdx, Mat* varType, Mat* missingDataMask, CvBoostParams* params, bool update) {
	return self->train(*trainData, tflag, *responses, *varIdx, *sampleIdx, *varType, *missingDataMask, *params, update);
}
bool cv_CvGBTrees_train9_0(CvGBTrees* self, Mat* trainData, int tflag, Mat* responses, Mat* varIdx, Mat* sampleIdx, Mat* varType, Mat* missingDataMask, CvGBTreesParams* params, bool update) {
	return self->train(*trainData, tflag, *responses, *varIdx, *sampleIdx, *varType, *missingDataMask, *params, update);
}
